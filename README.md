...
After that I went to the Firebase console and created a new project "web app" for authentication. I copied he config details and added them to firebased.js in the app.
